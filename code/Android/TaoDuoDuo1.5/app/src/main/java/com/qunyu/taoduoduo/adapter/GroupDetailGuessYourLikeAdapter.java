...
public class GroupDetailGuessYourLikeAdapter extends BaseAdapter {
     ...
     * @param data    列表展现的数据
     */
    public GroupDetailGuessYourLikeAdapter(Context context, List<GuessYourLikeBean> data, GroupDetailView goodsDetailView
    ) {
        mContext = context;
        mData = data;
