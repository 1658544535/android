...
public class LotteryListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseSetContentView(R.layout.lotterylist_activity);
        ...
        iv_fenxiang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                backgroundAlpha(LotteryListActivity.this, 0.5f);
                getSharePopupWindow();
                // 这里是位置显示方式,在屏幕的左侧
    ...
    private void GetShareContentApiGet() {
        ...
        AbHttpUtil.getInstance(LotteryListActivity.this).get(Constant.getShareContentApi, params, new AbStringHttpResponseListener() {
...
//                AbDialogUtil.removeDialog(LoginActivity.this);
            ...
            public void onFailure(int statusCode, String content, Throwable error) {
                ToastUtils.showShortToast(LotteryListActivity.this, "网络异常，数据加载失败");
            }
...
//                        Log.d("++++", "onSuccess: " + networkImages.get(1).getImage());
    ...
    protected void initSharePopuptWindow() {
        ...
        backgroundAlpha(LotteryListActivity.this, 0.5f);// 0.0-1.0
        popupWindow1.setOnDismissListener(new PopupWindow.OnDismissListener() {

            @Override
            public void onDismiss() {
                // TODO Auto-generated method stub
                backgroundAlpha(LotteryListActivity.this, 1f);
            }
        });
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onResult(SHARE_MEDIA platform) {
            ...
            Toast.makeText(LotteryListActivity.this, platform + " 分享成功啦", Toast.LENGTH_SHORT).show();

        }

        @Override
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(LotteryListActivity.this, platform + " 分享失败啦", Toast.LENGTH_SHORT).show();
            if (t != null) {
        ...
        public void onCancel(SHARE_MEDIA platform) {
            Toast.makeText(LotteryListActivity.this, platform + " 分享取消了", Toast.LENGTH_SHORT).show();
        }
    };
}
