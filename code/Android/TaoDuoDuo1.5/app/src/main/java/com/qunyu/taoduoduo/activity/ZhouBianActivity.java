...
public class ZhouBianActivity extends Activity implements View.OnClickListener, ZhouBianView {
    ...
    private void geekValid() {
        ...
        AbHttpUtil.getInstance(ZhouBianActivity.this).get(Constant.geekValid, new AbStringHttpResponseListener() {
...
//                }).create().show();
    ...
    private Context context = ZhouBianActivity.this;
