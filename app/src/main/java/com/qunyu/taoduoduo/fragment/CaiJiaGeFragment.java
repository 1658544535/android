...
//                AbDialogUtil.removeDialog(LoginActivity.this);
            ...
            public void onSuccess(int statusCode, String content) {
                ...
                try {
                    if (result.getResultCode() == AbResult.RESULT_OK) {
                        ...
                        TextView tv_rule = (TextView) vHead.findViewById(R.id.tv_rule);
                        ...
                        Glide.with(getActivity()).load(base.result.getBanner()).placeholder(R.mipmap.default_load_long).error(R.mipmap.default_load_long).into(imageView1);
    ...
    private void GuessActivityGet() {
        ...
        AbHttpUtil.getInstance(getActivity()).get(Constant.guessActivityApi, params, new AbStringHttpResponseListener() {
                ...
                if (result.getResultCode() == AbResult.RESULT_OK) {
                    ...
                    if (base.result!=null) {
                        if (pageNo == 1) {
                            ...
                            adapter = new GuessActivityApiAdapter(getActivity(), date);
                            if(base.success){
